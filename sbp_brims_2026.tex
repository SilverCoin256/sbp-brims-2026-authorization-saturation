...
\email{shauryagupta042@gmail.com}}
...
$k$. Rather than asserting a dynamic fit, this calibration acts as a generative counterfactual to diagnose the structural source of agency backlogs. The observable signatures are broadly consistent with the model: a 125-day backlog threshold (operational $T$) and elevated appeal reversal rates (observable $q_c$). This calibration demonstrates how standard aggregate metrics map directly to the system's steady-state parameters, predicting $\rho_s > 1.0$ (chronic overload) without needing fine-grained queue telemetry.
